...
##  Sal Head Start##
        ...
        graph1_sal = F.interpolate(graph_sal1, size=size, mode='bilinear', align_corners=True)
##  Sal Head End ##

        return sal_out, self.sigmoid(sal_out), edg_out, sal2, self.sigmoid(sal2), edg2,  sal3, self.sigmoid(sal3), edg3,\
            sal4, self.sigmoid(sal4), edg4, edge_sal, graph_sal, self.sigmoid(graph_sal),  graph1_sal, self.sigmoid( graph1_sal)
